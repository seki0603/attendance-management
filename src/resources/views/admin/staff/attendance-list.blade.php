...
@section('content')
    <div class="list__wrapper">
        <div class="list">
            <h1 class="list__title">{{ $displayName }}さんの勤怠</h1>

            {{-- 月ページャー --}}
            <div class="list__month-wrapper">
                <a class="list__last-month" href="{{ $previousMonthUrl }}">
                ...
                <a class="list__next-month" href="{{ $nextMonthUrl }}">
            ...
            {{-- CSV出力ボタン --}}
            <div class="list__csv-wrapper">
                <a class="list__csv-button" href="{{ $csvExportUrl }}">CSV出力</a>
            </div>
        </div>
    </div>
@endsection