...
<div class="list__wrapper">
    <div class="list">
        ...
        <div class="tab">
            <a href="{{ route('correction.list', ['tab' => 'waiting']) }}" class="tab__link {{ $tab === 'waiting' ? 'tab__link--active' : '' }}">
                承認待ち
            </a>
            <a href="{{ route('correction.list', ['tab' => 'completed'])}}" class="tab__link {{ $tab === 'completed' ? 'tab__link--active' : '' }}">
                承認済み
            </a>
        </div>
